...
public class LoginController {
	...
	public ModelAndView sellermove(@ModelAttribute SellerJoinVO svo, Model model, HttpServletResponse response) throws Exception {
		ModelAndView mav = new ModelAndView();
	...
	public ModelAndView sellerchange(@ModelAttribute SellerJoinVO svo, Model model, HttpServletResponse response) throws Exception {
	...
	public ModelAndView usermove(@ModelAttribute UserJoinVO uvo, Model model, HttpServletResponse response) throws Exception {
		ModelAndView mav = new ModelAndView();
	...
	public ModelAndView userchange(@ModelAttribute UserJoinVO uvo, Model model, HttpServletResponse response) throws Exception {
	...
	public @ResponseBody String idList(@ModelAttribute SellerJoinVO svo, Model model, HttpServletResponse response) throws Exception {
	...
	public @ResponseBody String idList(@ModelAttribute UserJoinVO uvo, Model model, HttpServletResponse response)throws Exception {
