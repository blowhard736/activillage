			...
			<form id="loginForm" name="loginForm">
				...
				<div>
					<input type="text" id="s_email" name="s_email"
						placeholder="사업자아이디(이메일)" maxlength="50" /> <input
						type="password" id="s_pw" name="s_pw" placeholder="사업자비밀번호"
						min="8" maxlength="20" /> <input type="text" id="u_email"
						name="u_email" placeholder="사용자아이디(이메일)" maxlength="50" /> <input
						type="password" id="u_pw" name="u_pw" placeholder="사용자비밀번호"
						min="8" maxlength="20" />
				</div>
				<div>
					<a href="/login/idSearch">아이디 찾기</a> <a href="/login/pwSearch">비밀번호
						찾기</a>
				</div>
				<div>
